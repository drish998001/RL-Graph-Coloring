...
class ActorCritic(nn.Module):
    def __init__(
        ...
        self.k = k
        self.actor_net = actor_class(2, hidden_dim, self.k+2, num_layers)
    ...
    def get_masks_idxs_subg_h(self, ob, g):
        ...
        node_mask = (ob.select(2, 0).long() == self.k+1)
        flatten_node_idxs = node_mask.flatten().nonzero().squeeze(1)
        ...
        flatten_subg_node_idxs = subg_node_mask.flatten().nonzero().squeeze(1)
